        ...
        <>
            ...
            <div className="absolute top-1/2 -translate-y-1/2 text-center w-full text-white main-slider__details">
                ...
                <TextModifier
                    ...
                    highlight={["CARE", "SMILE", "HEALTH", "SURGEON", "time", "Lifestyle", "assistance"]}
                    highlightClassName="text-4xl md:text-5xl lg:text-6xl text-orange-500"
                />
                <button className='text-xl font-bold font-serif my-6 bg-emerald-500 p-4 rounded-full'>Read More</button>
                <button className='text-xl font-bold font-serif my-6 bg-yellow-500 p-4 rounded-full ms-5'>Contact Us</button>
