            ...
            <form onSubmit={(e)=> handlePrescription(e)} >
                ...
                {/* <div className="form-control full">
                    ...
                    <div className="form-control full">
                        ...
                        <input type="text" name='name' value={patient.name} placeholder="name" className="input input-bordered" required/>
                    </div>
                ...
                <div className='grid grid-cols-1 lg:grid-cols-2 gap-2  font-bold '>
                    ...
                    <div className="form-control full">
                        ...
                        <input type="datetime-local" name='Date_Time' placeholder="Date & Time" className="input input-bordered" required />
                    </div>
