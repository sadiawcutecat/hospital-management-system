        ...
        <div>
            -
            {
                testimonialData.map(patientAppoint => {
                    ...
                    return <div key={patientAppoint._id} className="">
                        <div className=" flex  shadow-lg p-8 ">
                            <img src={patientAppoint.picture} alt="" className="mask mask-squircle w-24 h-24 mt-3" />
                           
                                <div className="ms-6">
                                    <h2 className="font-bold">{patientAppoint.name}</h2>
                                    <p className="flex"><AiOutlineClockCircle className="mt-1 me-2"/>{patientAppoint.date}, {patientAppoint.time}</p>
                                    <p className="flex"><ImLocation2 className="mt-1 me-2"/>{patientAppoint.location}</p>
                                    <p className="flex"><AiOutlineMail className="mt-1 me-2"/>{patientAppoint.email}</p>
                                    <p className="flex"><FaPhoneAlt className="mt-1 me-2"/>{patientAppoint.contact}</p>
                                </div>
